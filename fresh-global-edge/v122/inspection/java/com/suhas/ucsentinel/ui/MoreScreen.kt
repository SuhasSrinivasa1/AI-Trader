        ...
        item{
            ElevatedCard(Modifier.fillMaxWidth()){
                Column(Modifier.padding(14.dp),verticalArrangement=Arrangement.spacedBy(8.dp)){
                    ...
                    if(adaptive){
                        Text("UC score band 66–88 • Pressure score band 62–86 • spike target +1.5–4.5% per candidate • pressure cutoff 6–10x by setup stage",style=MaterialTheme.typography.bodySmall,color=MaterialTheme.colorScheme.primary)
                    }
                }
            }
        }
