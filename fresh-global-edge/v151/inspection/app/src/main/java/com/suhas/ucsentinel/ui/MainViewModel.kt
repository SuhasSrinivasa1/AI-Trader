...
class MainViewModel(private val repo:GlobalEdgeAITraderRepository):ViewModel(){
    ...
    fun placeManualOrder(symbol:String,side:String,product:String,quantity:Int,expectedEntryPrice:Double,onResult:(Boolean,String)->Unit)=viewModelScope.launch{
